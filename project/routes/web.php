...
Route::post('/detail', 'Front\FrontendController@detail')->name('front.cars.detail');
...
Route::post('/get_car_api', 'Front\FrontendController@getCarsByPagination')->name('front.carApi');
Route::post('/get_car_api2', 'Front\FrontendController@getAutotrader')->name('front.carApi2');
