...
<head>
    ...
    <!-- custom pagination -->
    <link rel="stylesheet" href="{{ asset('assets/front/css/custom-pagination.css') }}">
    ...
    <style>
        ...
        .loading__anim {
            width: 100px;
            height: 100px;
            border: 10px solid rgba(189, 189, 189, 0.25);
                            ...
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item">
                                    <a class="nav-link @if (request()->path() == '/') active @endif"
                                        href="{{ route('front.index') }}">{{ $langg->lang1 }}</a>
                                </li>
                                <li class="nav-item">
                                ...
                                @if ($ps->is_contact == 1)
                                    <li class="nav-item">
                                        <a class="nav-link @if (request()->path() == 'contact') active @endif"
                                            href="{{ route('front.contact') }}">{{ $langg->lang6 }} </a>
                                    </li>
                                @endif
                            </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="footer-widget  footer-newsletter-widget">
                        ...
                        <div class="gocover"
                            style="background: url({{ asset('assets/front/images/loader.gif') }}) no-repeat scroll center center rgba(45, 45, 45, 0.5);">
                        </div>
